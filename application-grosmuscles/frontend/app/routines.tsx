...
export default function Routines() {
  ...
  const handleStartRoutine = (routine: any) => {
    const standardExercises = [
      {
        ...
        group: 'Pecs • Barre',
        // sets: 4, // Ces propriétés ne font pas partie de l'interface Exercise
        // reps: 8, // Elles sont gérées au niveau des séries
        // weight: '80 kg', //
    ...
    setCurrentSession({
      id: Date.now().toString(), // Générer un ID unique pour la session
      name: routine.name,
